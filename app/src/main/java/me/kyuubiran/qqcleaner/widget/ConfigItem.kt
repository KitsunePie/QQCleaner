 ...
 */
class ConfigItem(context: Context, attr: AttributeSet) : LinearLayout(context, attr) {
    var checked = false

    private var isRun = false

    private  var name: String = "新配置"

    private  var author: String = "作者 我"
    ...
    fun getAnimateImageRes(on: Boolean): Int {
        return if (on) switch_default_on_to_off else switch_default_off_to_on
    }
